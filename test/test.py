...
class ParsingTestCase(unittest.TestCase):
    ...
    def test_hash_only(self):
        self.assertEquals(Version(0, 0, commit_hash="abcdefg"), Version.parse_from("abcdefg"))

    def test_hash_only_dirty(self):
        self.assertEquals(Version(0, 0, commit_hash="abcdefg", is_dirty=True), Version.parse_from("abcdefg-dirty"))

    def test_tag_only(self):
        self.assertEquals(Version(1, 2, 3), Version.parse_from("v1.2.3"))
        self.assertEquals(Version(1, 2, 3), Version.parse_from("1.2.3"))

    def test_tag_only_dirty(self):
        self.assertEquals(Version(1, 2, 3, is_dirty=True), Version.parse_from("v1.2.3-dirty"))
        self.assertEquals(Version(1, 2, 3, is_dirty=True), Version.parse_from("1.2.3-dirty"))

    def test_tag_only_no_patch(self):
        self.assertEquals(Version(1, 2, 0), Version.parse_from("v1.2"))
        self.assertEquals(Version(1, 2, 0), Version.parse_from("1.2"))

    def test_tag_only_no_patch_dirty(self):
        self.assertEquals(Version(1, 2, 0, is_dirty=True), Version.parse_from("v1.2-dirty"))
        self.assertEquals(Version(1, 2, 0, is_dirty=True), Version.parse_from("1.2-dirty"))
    ...
    def test_pre_release_ids(self):
        self.assertEquals(Version(1, 2, 3, "alpha.3"), Version.parse_from("1.2.3-alpha.3"))
        self.assertEquals(Version(1, 2, 3, "alpha.3-special"), Version.parse_from("1.2.3-alpha.3-special"))
        self.assertEquals(Version(1, 2, 3, "alpha.3-more-special"), Version.parse_from("1.2.3-alpha.3-more-special"))
        self.assertEquals(Version(1, 2, 3, "alpha.3", None, 0, True), Version.parse_from("v1.2.3-alpha.3-dirty"))
